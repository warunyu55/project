    ...
    <div class="flex-column d-flex w-100 h-100">
        <header class="mb-auto">
            ...
            <div class="jumbotron text-center">
                <h1>ยินดีตอนรับเข้าสู่ระบบสมาชิก</h1>
                <p>Welcome to Manage Member</p>
            </div>
        </header>
        <div class="container">
            ...
            <table class="mytable table table-hover" style="text-align: center;">
                ...
                <?php
                    $sql="SELECT * FROM tb_member Where mem_type='member' Order by id  asc " or die ("Error".mysqli_error());
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href='member-up.php?id=<?php echo $row[0]?>' class='btn btn-warning' style='color:white'><i
                                    class='fas fa-edit'></i></a>
                        </td>
                        <td>
                            <a href="member-del.php?id=<?php echo $row[0]?>" class='btn btn-danger'
